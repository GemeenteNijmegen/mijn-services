...
export class OMCService extends Construct {
  ...
  private getEnvironmentConfiguration() {
    ...
    return {
      ...
      OMC_AUTHORIZATION_JWT_EXPIRESINMIN: '60', // The OMC JWT tokens are generated by OMC and authorized by Open services. New JWT token has to be generated manually, using OMC dedicated library, if the token validity expire (by default it is 60 minutes)
      ...
      OMC_API_BASEURL_NOTIFYNL: 'https://example.com', // The domain where your Notify API instance is listening (e.g.: "https://api.notifynl.nl")
      ...
      USER_DOMAIN_OPENNOTIFICATIES: 'mijn-services.accp.nijmegen.nl', // You have to use ONLY the domain part from URLs where you are hosting the dedicated Open services
      USER_DOMAIN_OPENZAAK: 'mijn-services.accp.nijmegen.nl', // You have to use ONLY the domain part from URLs where you are hosting the dedicated Open services
      USER_DOMAIN_OPENKLANT: 'mijn-services.accp.nijmegen.nl', // You have to use ONLY the domain part from URLs where you are hosting the dedicated Open services
      USER_DOMAIN_OBJECTEN: 'mijn-services.accp.nijmegen.nl', // You have to use ONLY the domain part from URLs where you are hosting the dedicated Open services
      USER_DOMAIN_OBJECTTYPEN: 'mijn-services.accp.nijmegen.nl', // You have to use ONLY the domain part from URLs where you are hosting the dedicated Open services
      ...
      USER_WHITELIST_MESSAGE_ALLOWED: 'false', // Cannot be missing and have null or empty value 	Is provided by the user
